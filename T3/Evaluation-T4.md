...
- [ ] Tous les fichiers sources sont correctement organisés et suivent des règles de nommage claires.
- [ ] L'ensemble des fichiers est partagé et structuré de manière cohérente.
- [ ] Certains fichiers manquent d'organisation ou ne sont pas partagés correctement.

### Gestion des versions

- [ ] Les commits sont réalisés avec une granularité adaptée et sont systématiquement bien renseignés.
- [ ] La granularité ou les messages des commits présentent des incohérences.
- [ ] La granularité des commits est inadéquate, et les messages manquent de clarté ou ne sont pas renseignés.

### Droits d'accès

- [x] Julien Gossa est désigné comme propriétaire du dépôt et celui-ci est accessible à tous les membres concernés.
- [ ] Julien Gossa est le propriétaire du dépôt GIT.
- [ ] Julien Gossa n'a pas été défini comme propriétaire du dépôt GIT.
...
- Installation
  - [ ] Le prototype s'installe facilement et automatiquement.
  - [ ] Le prototype s'installe correctement en suivant une procédure détaillée.
  - [ ] Le prototype ne s'installe pas correctement ou l'installation échoue.
- Exécution
  - [ ] Le prototype s'exécute en cliquant sur une icône.
  - [ ] Le prototype s'exécute en suivant une procédure.
  - [ ] Le prototype ne s'exécute pas ou présente des erreurs lors de l'exécution.
- Stabilité
  - [ ] Le prototype est parfaitement stable, sans aucun plantage ou dysfonctionnement.
  - [ ] Le prototype présente une bonne stabilité, avec des bugs ou plantages rares.
  - [ ] Le prototype est instable et présente des plantages fréquents ou des dysfonctionnements majeurs.
- Affordabilité
  - [ ] Toutes les instructions de jeu sont incluse dans le prototype au cours d'une partie normale.
  - [ ] Les instructions de jeu sont sous forme d'un manuel ou d'un tutoriel à part.
  - [ ] Les instructions de jeu ne sont pas données.
- Cross-Plateforme
  - [ ] Le prototype est fonctionnel sur toutes les plateformes.
  - [ ] Le prototype est fonctionnel sur deux plateformes.
  - [ ] Le prototype n'est fonctionnel que sur une seule plateforme.
- Graphismes
  - [ ] Les graphismes du jeux sont agréables et cohérents.
  - [ ] Les graphismes du jeux sont cohérents mais peuvent être améliorés.
  - [ ] Les graphismes du jeux ne sont pas cohérents ou agréables.
