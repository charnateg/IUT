...
- Il faudrait réexpliquer et développer la partie sur les contraintes de développement. On ne sait pas trop ce qui a voulu être dit.
- Les objectifs du joueur sont trop généraux, il faudrait les préciser et peut-être parler des actions à faire au lieu de leur contexte.
- La partie Interface pourrait également être précisée, en parlant de la carte, des bâtiments, des différentes salles et surtout que l'on peut interagir avec les objets et les PNJ.
- Il manque une partie sources ou références, où l'on pourrait trouver des liens vers des informations utiles, intéressantes ou des images de la base Concordia. (elle se trouve dans le README)


# Propositions d'amélioration du jeu

- Il y a des bugs à régler, comme quand on pert le jeu et que l'on veut recommencer, il n'y a plus la première quête.
- Quand on finit le jeu, il faudrait rajouter un ecran de fin : on ne sait pas quand on a gagné.
- La narration et les discussions avec les PNJ devrait être dans des vraies bulles de texte ou autre contenant, mais mas dans des alertes du navigateur.
- Il faudrait régler le problème des boutons non-cliquables.
...
Justifications :
Les fichiers sont bien rangés dans les bons dossiers et bien nommés, c'est une bonne organisation.
Les commits sont systématiquement précisés, même s'ils pourraient être plus détaillé mais ce n'est pas dérangant.
...
Résumer en une phrase ce que vous avez éventuellement appris : Dans ce milieu extrême, des problèmes simples comme celui de la fenêtre ouverte devient vite problématique. Cela nous apprene qu'il faut faire des choix et sacrifier des choses (comme le choix du thermostat) et faire les meilleurs choix pour la sécurité plutôt que le confort.

Autres justifications :
Le jeu étant hébergé comme un site web, il est très facile a accéder et a utiliser : il suffit d'y accéder par son url.
Les instructions dans le jeu son claires, nous avons des quêtes expliquées et même un contexte au lancement du jeu.
Malheureusement il y a quelques bug de boutons, mais le jeu reste stable, il ne crash pas.
