...
- La partie sur les contraintes de développement est trop succincte. On ne comprendsm pas vraiment ce qui a voulu etre dit.
- Les objectifs du joueur précise le contexte mais les actions du joueur. Cette partie popourrait etre modifié pour être moins générale.
- La partie interface pourrait etre développé en précisant qu'il y des salles ou des png.
- Il manque la partie Référence, pour avoir connaissance des infoinformations qui pourraient être utile. Elle est présente dans le README mais pas dans le cahier des charges
- 
# Propositions d'amélioration du jeu

- Ajouter un écran de fin
- Les quêtes ne se remetent pas a lorsqu'on perd
- Certains boutons ne sont pas cliquable. 
- Le petit pingouin pourrait etre un easter egg ou apporter une info sur les pingouins pour le côté pédagogique 
...
Justifications : Les fichiers ont un bon nomage, les fonctions et methodes sont nommés selon le camelCase. Les droits d'd'accès sont bien donnés.
...
Résumer en une phrase ce que vous avez éventuellement appris : Ce jeu m'm'a apparis que dans des conditions extremes, comme l'Antartique, les problemes ne se resolent pas facilement et demande de choisir entre la sécurite et le confort.

Autres justifications : Le prototype n'a pas besoin d'installation. Il s'execute facilement. Le prototype comporte quelque bugs mais ne gene pas la jouabilite. 
