...
- Le cahier des charges est bien équilibré même si on peut mettre quelques images pour une meilleure compréhension.
- On peut aussi mettre des schémas par exemple pour lister les objectifs du joueur ou missions.
- On peut mettre dans les contraintes un âge limité, par exemple pour les moins de 7 ans. (PEGI 7)
- On peut aussi mettre en couleur les listes différentes pour reconnaitre rapidement les catégories différentes.
- Et sinon on peut aussi souligner les phrases importantes pour pouvoir mieux comprendre.

# Propositions d'amélioration du jeu

- On peut enlever les points pour cliquer alors qu'on pourrait juste illuminer la zone de click pour que ça soit plus beau et autant compéhensible.
- Avant d'accéder aux salles on peut mettre plus d'images comme par exemple pour la salle de sport pour que l'on puisse reconnaitre directement.
- On pourrait mettre plus en avant les missions données pour qu'il soit plus visible et plus beau.
- On pourrait ajouter des systèmes de points après chaque décision prise car elles comportent des sacrifices.
- On peut aussi ajouter des warnings, comme par exemple quand on prend des planches de bois et que donc il en manque dans la salle.
...
Résumer en une phrase ce que vous avez éventuellement appris : J'ai appris à quel point la vie en antarctique est difficile surtout pour les décisions à faire et même des sacrifices, ce qui est mentalement très dur.
