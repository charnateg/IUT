...
- Vu que le jeu est un point & click, éviter les gros boutons avec un emoji sur l'écran et plutot faire des images qui représentent l'objet et qui s'illuminent lorsque la souris passe dessus.
- Proposition 2
...
Résumer en une phrase ce que vous avez éventuellement appris : J'ai appris la complexité que peut ressentir un architecte dans une telle situation.

Autres justifications : Le logiciel n'est qu'un simple jeu web, donc aucune difficulté pour l'installer et l'éxecuter. Le jeu est étonnement stable, je n'ai trouvé aucun problème ni bug en jouant. Cependant il n'y a aucune aide en jeu (même si c'est un jeu simple à comprendre).
