...
- Plus de détails sur les fonctionalités et sénarios avancées (pour ne pas faire trop de recherche dans la doc enfin savoir de quoi en parle)
- Expliquer comment on peut résoudre les problèmes dans la partie objectif (et pas que dans Contraintes et dev)
- Expliquer un minimum comment est organisé la base

# Propositions d'amélioration du jeu

- Ajouter une temporalité au jeu été/hiver / ravitaillement / temps pour résoudre un problème
- Une notion de priorité des problèmes à regler.
- Rendre visible de contenu de l'invetaire.
...
J'ai appris qu'il faut faire des compromis entre confort et sécurité et que l'illégalité
